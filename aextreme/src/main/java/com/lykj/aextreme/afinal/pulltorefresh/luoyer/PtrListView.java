...
public class PtrListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	public static class DefaultEmptyViewProxy{
		 ...
		 */
		public void displayResultMsg(int msgid, int btnText, int btnbkg, OnClickListener btnListener){
			changeContentType(ContentType.TYPE_RESULT);
			restv.setText(msgid);
			restv.setVisibility(View.VISIBLE);
		...
		/**
		 * @see #displayResultMsg(int, int, int, OnClickListener)
		 */
		public void displayResultMsg(CharSequence msg, int btnText, int btnbkg, OnClickListener btnListener){
			changeContentType(ContentType.TYPE_RESULT);
			restv.setText(msg);
			restv.setVisibility(View.VISIBLE);
		...
		public void displayResultMsg(int msgid, int imgid, int btnText, 
				int btnbkg, OnClickListener btnListener){
			changeContentType(ContentType.TYPE_RESULT);
			resimg.setImageResource(imgid);
			restv.setText(msgid);
			resbtn.setBackgroundResource(btnbkg);
